...
> **STATUS 2026-07-22 — CORE v2.0.0-alpha.6; SIMS (#74) e voz/WOW (#75) integrados
> estaticamente; fuel da FASE 2 cortado para o CORE** (decisões/ADRs #37–#75 — mesma
> numeração no `contexto.md` e no `.claude/plano_core_v2/WORKLOG_CORE_V2.md`;
> **próximo livre = #76**):
