...
- **`PLANO_IMPLEMENTACAO_VEICULOS.md`** *(SUPERSEDED 2026-07-03 — ver arquivo)*: decisão #25 (conce é
  autoridade do catálogo — gate do merge do catalog-patch na Fase 2). O plano em si foi arquivado;
  esta referência vale só para a autoridade de catálogo, não para a abordagem de runtime.
